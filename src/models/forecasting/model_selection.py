...
class ModelEvaluator:
    ...
    def train_models(
        self,
        models_to_train: List[str] = ['arima', 'xgboost', 'lstm'],
        ...
        models_to_train : List[str], optional
            List of models to train, by default ['arima', 'xgboost', 'lstm']
    ...
    def load_models(
        self,
        models_to_load: List[str] = ['arima', 'xgboost', 'lstm']
    ) -> Dict[str, Any]:
        """
        ...
        models_to_load : List[str], optional
            List of models to load, by default ['arima', 'xgboost', 'lstm']
